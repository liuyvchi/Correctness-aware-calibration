    ...
    def set_temperature(self, logits, temp_arg, labels):
        ...
        for epoch in range(10):
            ...
            for batch_data, batch_labels in data_loader:
                ...
                loss_CE = CE_criterion(outputs, batch_labels)

                loss_CA = mse_criterion(conf_out, correctness.float())
                ...
                if epoch % 50 == 0 and print_flag:  
                    ...
                    print(epoch, loss_CE.mean().item(), loss_CA.mean().item(), loss_correctness.mean().item(), correctness_acc.item(), correctness.sum().item())
