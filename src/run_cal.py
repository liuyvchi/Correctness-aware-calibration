...
def test(test_loader, valid_loader, device, save_path, d_name='a', m_name='Resnet152', method='3NT4_CA'):
    ...
    erros_uncal = all_meausres(softmax_test.numpy(), test_labels.numpy(), correctness_test.numpy())
    temperature_model.eval()
    ...
    erros_cal = all_meausres(softmax_cal_test.numpy(), test_labels.numpy(), correctness_test.numpy())
